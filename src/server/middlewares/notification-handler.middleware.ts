...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'OrderCreated.create': {
    roles: ['business-owner', 'manager', 'employee'],
    key: 'order',
    tenantPath: [],
    userPath: [],
  },
  'InventoryLow.update': { roles: ['business-owner', 'manager'], key: 'inventory', tenantPath: [], userPath: [] },
...
const tenantRoles: string[] = ['business-owner', 'manager', 'employee', 'customer'];
