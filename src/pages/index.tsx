  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Employee Scheduling - Streamlining multi-location service management by scheduling employees at 100 different locations effortlessly."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Employee Scheduling - Streamlining multi-location service management by scheduling employees at 100 different locations effortlessly.`}
            </Text>
            <Box
